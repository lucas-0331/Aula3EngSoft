...
urlpatterns = [
    ...
    path('disciplina/', disciplina, name='curso'),
    path('matriculado/', matriculado, name='matriculado'),
    path('avaliacao/', avaliacao, name='avaliacao'),
    path('frequencia/', frequencia, name='frequencia'),
    path('periodoturma/', periodoturma, name='periodoturma'),
    path('ocorrencia/', ocorrencia, name='ocorrencia'),
    path('disciplinacurso/', disciplinacurso, name='disciplinacurso'),
]
